...
export function statusColor(s: string) {
  const m: Record<string,string> = {done:'text-emerald-400',running:'text-blue-400',failed:'text-red-400',pending:'text-yellow-400',idle:'text-slate-500',planning:'text-purple-400',executing:'text-blue-400'}
