export default {
  dashboard:"ড্যাশবোর্ড", chat:"চ্যাট / কাজ", memory:"মেমরি সেন্টার", knowledge:"নলেজ বেস", workspaces:"ওয়ার্কস্পেস", liveChat:"লাইভ চ্যাট",
  tools:"টুল ম্যানেজার", analytics:"অ্যানালিটিক্স", cost:"খরচ ও বাজেট",
  workflow:"ওয়ার্কফ্লো বিল্ডার", scheduler:"শিডিউলার", projects:"প্রজেক্ট", deviceBridge:"ডিভাইস ব্রিজ", plugins:"প্লাগইন মার্কেটপ্লেস",
